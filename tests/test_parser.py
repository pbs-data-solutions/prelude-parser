...
def test_site_native_to_json(site_native_small_xml):
    ...
    assert (
        result_json
        == '{"export":{"date":"2024-06-01T23:17:00Z","createdBy":"Paul Sanders","role":"Project Manager","numberSubjectsProcessed":2,"pageNumber":null},"sites":[{"name":"Some Site","uniqueId":"1681574834910","numberOfPatients":4,"countOfRandomizedPatients":0,"whenCreated":"2023-04-15T16:08:19Z","creator":"Paul Sanders","numberOfForms":1,"form":[{"name":"demographic.form.name.site.demographics","lastModified":"2023-04-15T16:08:19Z","whoLastModifiedName":"Paul Sanders","whoLastModifiedRole":"Project Manager","whenCreated":1681574834930,"hasErrors":false,"hasWarnings":false,"locked":false,"user":null,"dateTimeChanged":null,"formTitle":"Site Demographics","formIndex":1,"formGroup":"Demographic","formState":"In-Work","states":[{"value":"form.state.in.work","signer":"Paul Sanders - Project Manager","signerUniqueId":"1681162687395","dateSigned":"2023-04-15T16:08:19Z"}],"lock_states":null,"categories":[{"name":"Demographics","categoryType":"normal","highestIndex":0,"obfuscated":false,"overRideHighestIndex":false,"fields":[{"name":"company","fieldType":"text","dataType":"string","errorCode":"valid","whenCreated":"2023-04-15T16:07:14Z","keepHistory":true,"entries":[{"entryId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-04-15T16:08:19Z","value":"Some Company"},"reason":null}],"comments":[{"commentId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-04-15T16:09:02Z","value":"Some comment"}}],"queries":null}],"files":null}]}]}]}'
    )
...
def test_subject_native_to_json(subject_native_small_xml):
    ...
    assert (
        result_json
        == '{"export":{"date":"2024-05-30T15:35:00Z","createdBy":"Paul Sanders","role":"Project Manager","numberSubjectsProcessed":4,"pageNumber":null},"patients":[{"patientId":"ABC-001","uniqueId":"1681574905819","whenCreated":"2023-04-15T16:09:02Z","passwordChangeDate":null,"creator":"Paul Sanders","siteName":"Some Site","siteUniqueId":"1681574834910","lastLanguage":null,"numberOfForms":6,"forms":[{"name":"day.0.form.name.demographics","lastModified":"2023-04-15T16:09:15Z","whoLastModifiedName":"Paul Sanders","whoLastModifiedRole":"Project Manager","whenCreated":1681574905839,"hasErrors":false,"hasWarnings":false,"locked":false,"user":null,"dateTimeChanged":null,"formTitle":"Demographics","formIndex":1,"formGroup":"Day 0","formState":"In-Work","states":[{"value":"form.state.in.work","signer":"Paul Sanders - Project Manager","signerUniqueId":"1681162687395","dateSigned":"2023-04-15T16:09:02Z"}],"lock_states":null,"categories":[{"name":"Demographics","categoryType":"normal","highestIndex":0,"obfuscated":false,"overRideHighestIndex":false,"fields":[{"name":"breed","fieldType":"combo-box","dataType":"string","errorCode":"valid","whenCreated":"2023-04-15T16:08:26Z","keepHistory":true,"entries":[{"entryId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-04-15T16:09:02Z","value":"Labrador"},"reason":null}],"comments":[{"commentId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-04-15T16:09:02Z","value":"Some comment"}}],"queries":null}],"files":null}]}]}]}'
    )
...
def test_user_native_to_json(user_native_small_xml):
    ...
    assert (
        result_json
        == '{"export":{"date":"2024-06-02T11:59:00Z","createdBy":"Paul Sanders","role":"Project Manager","numberSubjectsProcessed":3,"pageNumber":null},"users":[{"uniqueId":"1691421275437","lastLanguage":null,"creator":"Paul Sanders(1681162687395)","numberOfForms":1,"forms":[{"name":"form.name.demographics","lastModified":"2023-08-07T15:15:41Z","whoLastModifiedName":"Paul Sanders","whoLastModifiedRole":"Project Manager","whenCreated":1691421341578,"hasErrors":false,"hasWarnings":false,"locked":false,"user":null,"dateTimeChanged":null,"formTitle":"User Demographics","formIndex":1,"formGroup":null,"formState":"In-Work","states":[{"value":"form.state.in.work","signer":"Paul Sanders - Project Manager","signerUniqueId":"1681162687395","dateSigned":"2023-08-07T15:15:41Z"}],"lock_states":null,"categories":[{"name":"demographics","categoryType":"normal","highestIndex":0,"obfuscated":false,"overRideHighestIndex":false,"fields":[{"name":"email","fieldType":"text","dataType":"string","errorCode":"undefined","whenCreated":"2023-08-07T15:15:41Z","keepHistory":true,"entries":[{"entryId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-08-07T15:15:41Z","value":"jazz@artemis.com"},"reason":null}],"comments":[{"commentId":"1","reviewedBy":null,"reviewedByUniqueId":null,"reviewedByWhen":null,"value":{"by":"Paul Sanders","byUniqueId":"1681162687395","role":"Project Manager","when":"2023-04-15T16:09:02Z","value":"Some comment"}}],"queries":null}],"files":null}]}]}]}'
    )
